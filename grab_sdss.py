...
Galaxies Query:
    SELECT p.ra, p.dec, p.modelMag_u, p.modelMagErr_u, p.modelMag_g, p.modelMagErr_g, p.modelMag_r, p.modelMagErr_r, p.modelMag_i, p.modelMagErr_i, p.modelMag_z, p.modelMagErr_z, p.cmodelMag_u, p.cmodelMagErr_u, p.cmodelMag_g, p.cmodelMagErr_g, p.cmodelMag_r, p.cmodelMagErr_r, p.cmodelMag_i, p.cmodelMagErr_i, p.cmodelMag_z, p.cmodelMagErr_z, extinction_u, extinction_g,extinction_r, extinction_i, extinction_z FROM fGetNearbyObjEq(ra,dec,radius) n, Galaxy p WHERE n.objID=p.objID
...
ascii.write(star_tab, datapath+clustername+'_star_sdss_radec.ecsv', format='ecsv')
ascii.write(gal_tab, datapath+clustername+'_gal_sdss_radec.ecsv', format='ecsv')
