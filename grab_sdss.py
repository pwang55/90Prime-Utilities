...
Stars Query:
    ...
    extinction_u, extinction_g,extinction_r, extinction_i, extinction_z, clean, s.z, s.zerr
...
# star_tab = Table(star_tab, dtype=[float for x in range(len(star_tab.colnames))])
# gal_tab = Table(star_tab, dtype=[float for x in range(len(gal_tab.colnames))])
